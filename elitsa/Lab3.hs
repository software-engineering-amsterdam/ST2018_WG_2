...
entails formulaA formulaB = forall (filter (\value -> evl value formulaA) (allVals formulaA)) (\value -> evl value formulaB )
entails' formulaA formulaB = and $ zipWith (\a b -> evl a formulaB --> evl b formulaB ) (allVals formulaA) (allVals formulaB)
...
isFormulaContradictionAndTautology :: Form -> Bool
isFormulaContradictionAndTautology formula =  (contradiction formula) && (tautology formula)

checkEntails:: Form -> Form -> Bool
checkEntails formulaA formulaB = entails formulaA formulaB && entails formulaB formulaA
...
exercise1TestCases = [
        ...
        (checkEntails form1 form2,False),
        (checkEntails form2 form1,False),
        (checkEntails form1 form1, True) 

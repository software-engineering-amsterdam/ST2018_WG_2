...
-- =================================
-- == Testing Properties Strength == 1:30:00
-- =================================
prop1 :: Int -> Bool
prop1 x = x > 3 && even x
prop2 :: Int -> Bool
...
{-
This solution works IF there are duplicates in the input list
...
--MARTIN TODO: swap random 2 elements ONLY
...
--TODO MARTIN: document properties
